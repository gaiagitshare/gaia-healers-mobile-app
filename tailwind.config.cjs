module.exports = {
  content: ['./*.html', './*.js', './admin/**/*.{html,js}'],
  theme: {
    extend: {
      colors: {
        gaia: { DEFAULT: '#5CB82E', dark: '#449422', light: '#7DD956', muted: '#EBF7E4', wash: '#F6FBF3' },
        ink: { DEFAULT: '#1C1C1E', secondary: '#636366', tertiary: '#AEAEB2' },
        surface: { DEFAULT: '#FFFFFF', subtle: '#F5F5F7', muted: '#EFEFF0' },
      },
      fontFamily: { sans: ['Plus Jakarta Sans', '-apple-system', 'BlinkMacSystemFont', 'system-ui', 'sans-serif'] },
      fontSize: {
      ...
      boxShadow: {
        soft: '0 1px 2px rgba(0,0,0,.04),0 4px 20px rgba(0,0,0,.04)',
        card: '0 2px 8px rgba(0,0,0,.04),0 12px 40px rgba(0,0,0,.06)',
        lift: '0 8px 32px rgba(0,0,0,.08),0 2px 8px rgba(0,0,0,.04)',
      },
    },
  },
  plugins: [],
