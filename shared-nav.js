...
(function () {
  const tabs = [
    ...
    { id: 'chakras', href: 'home.html?view=chakras', label: 'Chakras' },
  ...
  const icons = {
    ...
    chakras: '<path stroke-linecap="round" stroke-linejoin="round" d="M12 3v18M8.25 6a3.75 3.75 0 107.5 0M8.25 12a3.75 3.75 0 107.5 0M8.25 18a3.75 3.75 0 107.5 0" />',
